...
public class VoGenerator implements Generator {
    ...
    public void maker(Table table) throws CodeGenerationException {
        ...
        String voPackages = PackageHolder.getVoPackage(tableName);
        ...
        // 包声明
        builder.append("package ").append(voPackages).append(";");
        ...
        OutputUtils.newLine(builder);
        builder.append("import ").append(baseVoPackage).append(".BaseVo;");
        OutputUtils.newLine(builder);
        ...
        builder.append("/**");
        OutputUtils.newLine(builder);
        builder.append(" * ").append(tableName).append(" 表的请求入参视图对象");
        OutputUtils.newLine(builder);
        ...
        // 类定义
        builder.append("public class ").append(voName).append(" extends BaseVo {");
        OutputUtils.newLine(builder, 2);
        ...
        String filePath = targetPath + "/" + voPackages.replaceAll("\\.", "/") + "/" + voName + ".java";
