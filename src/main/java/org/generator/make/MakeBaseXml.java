...
public class MakeBaseXml {
    ...
    public static void makerBaseXml(Table table) throws Exception {
        ...
        OutputUtilities.newLine(builder);
        OutputUtilities.javaIndent(builder, 10);
        ...
        if (table.getPrimaryKey() != null && table.getPrimaryKey().size() > 0) {
            ...
            OutputUtilities.newLine(builder);
            OutputUtilities.javaIndent(builder, 1);
            builder.append("<select id=\"selectByPrimaryKey\" parameterType=\"java.util.Map\" resultMap=\"BaseResultMap\">");
            OutputUtilities.newLine(builder);
            OutputUtilities.javaIndent(builder, 2);
            builder.append("select");
            OutputUtilities.newLine(builder);
            ...
            OutputUtilities.newLine(builder);
            OutputUtilities.javaIndent(builder, 1);
            builder.append("<select id=\"selectByPrimaryKey_physical\" parameterType=\"java.util.Map\" resultMap=\"BaseResultMap\">");
            OutputUtilities.newLine(builder);
            OutputUtilities.javaIndent(builder, 2);
            builder.append("select");
            OutputUtilities.newLine(builder);
